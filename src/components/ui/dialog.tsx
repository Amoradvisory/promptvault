...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 hover:opacity-100 text-text-secondary hover:text-text-primary transition-opacity focus:outline-none cursor-pointer">
        <X className="h-4 w-4" />
